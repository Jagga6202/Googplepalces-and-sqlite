...
public class Query {
    ...
    public Query(String question, String description, String avatarPath) {
    ...
    public Query(String question, String description, String distance, String time,
                 String userName, String avatarPath, String tag) {
        this.question = question;
        this.description = description;
    ...
    public Query(Integer id, String question, String description, String distance, String time,
                 String userId, String userName, String avatarPath, String tag, Float lat, Float lng) {
        this.id = id;
        this.question = question;
        this.description = description;
        this.distance = distance;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(id).append(question).append(description).append(distance).append(time).append(userId).append(userName).append(avatarPath).append(tag).append(lat).append(lng).append(additionalProperties).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(id, rhs.id).append(question, rhs.question).append(description, rhs.description).append(distance, rhs.distance).append(time, rhs.time).append(userId, rhs.userId).append(userName, rhs.userName).append(avatarPath, rhs.avatarPath).append(tag, rhs.tag).append(lat, rhs.lat).append(lng, rhs.lng).append(additionalProperties, rhs.additionalProperties).isEquals();
    }
}
