...
public class DisplayTxtOptFragment extends Fragment {
    public String minTextOpt,maxTextOpt;
        ...
        if (!showingAnswers) {
            ...
            else
            {
                ...
                if (newOptionSelected != optionSelected)
                {
                    //updateHighLight(newOptionSelected);
                    optionSelected = newOptionSelected;
                    ColorDrawable back=(ColorDrawable) textOpts[optionSelected].getBackground();
                    int color=back.getColor();
                    if(color==Color.parseColor("#55EE0000"))
                    {
                        textOpts[optionSelected].setBackgroundColor(Color.parseColor("#D4D4D4D4"));
                    ...
                    else
                    {
                        ...
                        textOpts[optionSelected].setBackgroundColor(Color.parseColor("#55EE0000"));
                    }
                }
                else
                {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        minTextOpt=bundle.getString("choiceMin");
        maxTextOpt=bundle.getString("choiceMax");
    ...
    public static DisplayTxtOptFragment getInstance(AnswerProvidedMultiselect callabckMulti) {
        DisplayTxtOptFragment fragment = new DisplayTxtOptFragment();
