...
//=====================================================================popup code===========
        ...
        if (bundle!= null) {// to avoid the NullPointerException
            Boolean s = getIntent().getExtras().getBoolean("askquery");
            if (s) {
                nqueryDialog = new Dialog(this);
                nqueryDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
                nqueryDialog.getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT));
                nqueryDialog.setContentView(getLayoutInflater().inflate(R.layout.create_query, null));
                nqueryDialog.show();
                WindowManager.LayoutParams lp = new WindowManager.LayoutParams();
                lp.copyFrom(nqueryDialog.getWindow().getAttributes());
                lp.width = WindowManager.LayoutParams.MATCH_PARENT;;
                lp.height = WindowManager.LayoutParams.MATCH_PARENT;;
                nqueryDialog.getWindow().setAttributes(lp);
                ImageView fashionImg = (ImageView)nqueryDialog.findViewById(R.id.myImage);
