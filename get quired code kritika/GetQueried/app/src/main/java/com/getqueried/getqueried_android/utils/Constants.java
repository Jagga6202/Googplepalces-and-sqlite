...
public interface Constants {
    ...
    interface CreateQuery {
        ...
        String ANSWER_OPTION_IMAGE_4 = "answerOptionImage4";
        String ANSWER_OPTION_IMAGE_5 = "answerOptionImage5";
        String ANSWER_OPTION_IMAGE_6 = "answerOptionImage6";
        String ANSWER_OPTION_IMAGE_7 = "answerOptionImage7";
        String ANSWER_OPTION_IMAGE_8 = "answerOptionImage8";
        String ANSWER_OPTION_IMAGE_9 = "answerOptionImage9";
        String ANSWER_OPTION_IMAGE_10 = "answerOptionImage10";
        String ANSWER_OPTION_IMAGE_11 = "answerOptionImage11";
        ...
        //Jagga changes
        String NUMSLI="numsli";
        String RATSLI="ratsli";
    }
