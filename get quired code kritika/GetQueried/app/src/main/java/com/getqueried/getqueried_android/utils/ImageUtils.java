...
public class ImageUtils {
    ...
    public static boolean uploadImpOptQueryWithImage(Context context, String urlString, String method,
                                                     ...
                                                     Bitmap imageBitmap4,Bitmap imageBitmap5,Bitmap imageBitmap6,
                                                     Bitmap imageBitmap7,Bitmap imageBitmap8,Bitmap imageBitmap9,
                                                     Bitmap imageBitmap10,Bitmap imageBitmap11,Bitmap imageBitmap12) throws IOException {
        ...
        String answerOptionImage4Disposition = "Content-Disposition: form-data; name=\"answerOptionImage-0-4\"; " +
                "filename=\"answerOptionImage-0-4.jpg\"";
        String answerOptionImage5Disposition = "Content-Disposition: form-data; name=\"answerOptionImage-0-5\"; " +
                "filename=\"answerOptionImage-0-5.jpg\"";
        String answerOptionImage6Disposition = "Content-Disposition: form-data; name=\"answerOptionImage-0-6\"; " +
                "filename=\"answerOptionImage-0-6.jpg\"";
        String answerOptionImage7Disposition = "Content-Disposition: form-data; name=\"answerOptionImage-0-7\"; " +
                "filename=\"answerOptionImage-0-7.jpg\"";
        String answerOptionImage8Disposition = "Content-Disposition: form-data; name=\"answerOptionImage-0-8\"; " +
                "filename=\"answerOptionImage-0-8.jpg\"";
        String answerOptionImage9Disposition = "Content-Disposition: form-data; name=\"answerOptionImage-0-9\"; " +
                "filename=\"answerOptionImage-0-9.jpg\"";
        String answerOptionImage10Disposition = "Content-Disposition: form-data; name=\"answerOptionImage-0-10\"; " +
                "filename=\"answerOptionImage-0-10.jpg\"";
        String answerOptionImage11Disposition = "Content-Disposition: form-data; name=\"answerOptionImage-0-11\"; " +
                "filename=\"answerOptionImage-0-11.jpg\"";
        String contentType = "Content-Type: application/octet-stream";
        ...
        if (imageBitmap5 != null) {
            dataOS.write(buildStartPayload(answerOptionImage4Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            dataOS.write(getImageBytes(getResizedBitmap(imageBitmap5, Constants.IMG_WIDTH, Constants.IMG_HEIGHT)));
            dataOS.write((LINE_END).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(buildStartPayload(answerOptionImage4Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(("<ImageData>" + LINE_END).getBytes(Constants.CHARSET_UTF_8));
        }

        //AnswerOption5 Image
        if (imageBitmap6 != null) {
            dataOS.write(buildStartPayload(answerOptionImage5Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            dataOS.write(getImageBytes(getResizedBitmap(imageBitmap6, Constants.IMG_WIDTH, Constants.IMG_HEIGHT)));
            dataOS.write((LINE_END).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(buildStartPayload(answerOptionImage5Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(("<ImageData>" + LINE_END).getBytes(Constants.CHARSET_UTF_8));
        }

        //AnswerOption6 Image
        if (imageBitmap7 != null) {
            dataOS.write(buildStartPayload(answerOptionImage6Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            dataOS.write(getImageBytes(getResizedBitmap(imageBitmap7, Constants.IMG_WIDTH, Constants.IMG_HEIGHT)));
            dataOS.write((LINE_END).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(buildStartPayload(answerOptionImage6Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(("<ImageData>" + LINE_END).getBytes(Constants.CHARSET_UTF_8));
        }

        //AnswerOption7 Image
        if (imageBitmap8 != null) {
            dataOS.write(buildStartPayload(answerOptionImage7Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            dataOS.write(getImageBytes(getResizedBitmap(imageBitmap8, Constants.IMG_WIDTH, Constants.IMG_HEIGHT)));
            dataOS.write((LINE_END).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(buildStartPayload(answerOptionImage7Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(("<ImageData>" + LINE_END).getBytes(Constants.CHARSET_UTF_8));
        }

        //AnswerOption8 Image
        if (imageBitmap9 != null) {
            dataOS.write(buildStartPayload(answerOptionImage8Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            dataOS.write(getImageBytes(getResizedBitmap(imageBitmap9, Constants.IMG_WIDTH, Constants.IMG_HEIGHT)));
            dataOS.write((LINE_END).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(buildStartPayload(answerOptionImage8Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(("<ImageData>" + LINE_END).getBytes(Constants.CHARSET_UTF_8));
        }

        //AnswerOption9 Image
        if (imageBitmap10 != null) {
            dataOS.write(buildStartPayload(answerOptionImage9Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            dataOS.write(getImageBytes(getResizedBitmap(imageBitmap10, Constants.IMG_WIDTH, Constants.IMG_HEIGHT)));
            dataOS.write((LINE_END).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(buildStartPayload(answerOptionImage9Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(("<ImageData>" + LINE_END).getBytes(Constants.CHARSET_UTF_8));
        }

        //AnswerOption10 Image
        if (imageBitmap11 != null) {
            dataOS.write(buildStartPayload(answerOptionImage10Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            dataOS.write(getImageBytes(getResizedBitmap(imageBitmap11, Constants.IMG_WIDTH, Constants.IMG_HEIGHT)));
            dataOS.write((LINE_END).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(buildStartPayload(answerOptionImage10Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(("<ImageData>" + LINE_END).getBytes(Constants.CHARSET_UTF_8));
        }

        //AnswerOption11 Image
        if (imageBitmap12 != null) {
            dataOS.write(buildStartPayload(answerOptionImage11Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            dataOS.write(getImageBytes(getResizedBitmap(imageBitmap12, Constants.IMG_WIDTH, Constants.IMG_HEIGHT)));
            dataOS.write((LINE_END).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(buildStartPayload(answerOptionImage11Disposition, contentType).getBytes(Constants.CHARSET_UTF_8));
            logStream.write(("<ImageData>" + LINE_END).getBytes(Constants.CHARSET_UTF_8));
        }
