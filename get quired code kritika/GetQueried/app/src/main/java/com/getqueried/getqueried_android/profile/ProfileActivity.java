...
import com.getqueried.getqueried_android.TutActivity;
import com.getqueried.getqueried_android.WelcomeActivity;
   ...
   /* @Bind(R.id.textView_user_description)
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  userNameView.setOnClickListener(view -> {
        ...
        edit_image_btn.setOnClickListener(view -> {
            displayDetialsLayout.setVisibility(View.GONE);
            editDetailsLayout.setVisibility(View.VISIBLE);
        });
       ...
       /* slidingTabLayout.setDistributeEvenly(true);
        slidingTabLayout.setCustomTabColorizer(position -> {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
                return getColor(R.color.profiletabs);
            else
                return getResources().getColor(R.color.profiletabs);
        });
    ...
    /* else if(id == R.id.nav_rateus){
        ...
        else if(id == R.id.nav_seetut){
            Intent tut=new Intent(ProfileActivity.this, TutActivity.class);
            startActivity(tut);
