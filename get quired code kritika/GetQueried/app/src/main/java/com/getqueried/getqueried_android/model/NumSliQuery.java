...
public class NumSliQuery {
     ...
     * @param choiceMin
     */
    public NumSliQuery(String questionType, String text, Boolean hasImage, Integer choiceMin, Integer choiceMax) {
    ...
    public boolean equals(Object other) {
        ...
        NumSliQuery rhs = ((NumSliQuery) other);
